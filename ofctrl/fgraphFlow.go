...
type FlowAction struct {
	...
	l4Port        uint16          git      // Transport port to be set
...
func (self *Flow) installFlowActions(flowMod *openflow13.FlowMod,
	...
	for i := len(self.flowActions) - 1; i >= 0; i-- {
		...
		case ActTypePushMpls:
			...
			pushMpls := openflow13.NewActionPushMpls(flowAction.mplsEtherType)
		...
		case ActTypePopMpls:
			...
			popMpls := openflow13.NewActionPopMpls(flowAction.mplsEtherType)
